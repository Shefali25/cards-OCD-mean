(function () {
  ...
  describe('Admin Cards List Controller Tests', function () {
    // Initialize global variables
    var CardsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _CardsService_) {
      ...
      $httpBackend.whenGET('/modules/cards/client/views/list-cards.client.view.html').respond(200, '');
      ...
      CardsAdminListController = $controller('CardsAdminListController as vm', {
        $scope: $scope
      });
